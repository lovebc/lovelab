...
######## There is some problem with state41 (OR) that I have not solved!!
######## Look into it!
#state = ['41','55','8','29','24','27','25','4',
#         '51','34','26','39','17','42','36','12','48','6']
state = ['27','4','26','39','36','48','6']
...
for st in state:
    ...
    M['ConDis'] = M['ConDis'].astype(int)
    numClusters= int(max(M['ConDis']))
    problem = 'no'
    test = False
    par = 2.0
    if st == '4':
    ...
    while test == False:
        ...
        while test1 == False:
            ...
            clus = cluster.Ek_means_.KMeans(n_clusters=numClusters, max_iter= 800, n_init= 1, init= init_centers, n_jobs = 12, par = par)
