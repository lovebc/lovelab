...
## 2. Similarity functions for deep learning (FILLED, but try Sebastian Suarez <sebastian.suarez.12@ucl.ac.uk> if interested as there could be multiple projects within below)
